			 ...
			 <x-auth-session-status class="mb-4 text-center " :status="session('status')" />
                ...
                <form method="POST" action="{{ route('login') }}">
                    ...
                    <div class="col-12">
                        ...
                        <input name="email" type="email" class="form-control   @error('email') is-invalid @enderror" id="inputEmailAddress" placeholder="Admin@gmail.com">
                        @error('email')
                    ...
                    <div class="col-12">
                        ...
                        <div class="input-group" id="show_hide_password">
                            <input   name="password" type="password" class="form-control border-end-0   @error('password') is-invalid @enderror" id="inputChoosePassword"  placeholder="Enter Password"> <a href="javascript:;" class="input-group-text bg-transparent"><i class="bx bx-hide"></i></a>
                          @error('password')
                            <span class="text-danger">{{ $message }}</span>
                          @enderror
                        </div>
