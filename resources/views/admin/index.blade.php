...
<div class="page-content">
    ...
    @else
        ...
        <p class="text-danger">Please contact with the admin to activate your account</p>
                    ...
                    <div class="card radius-10 border-start border-0 border-4 border-info">
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                <div>
                                    <p class="mb-0 text-secondary">Total CMRS</p>
                                    <h4 class="my-1 text-info">{{$allCmr->count()}}</h4>
                                </div>
                ...
                <div class="col">
                    <div class="card radius-10 border-start border-0 border-4 border-danger">
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                <div>
                                    <p class="mb-0 text-secondary">Total Pending CMRS</p>
                                    <h4 class="my-1 text-danger">{{$pendingCmr->count()}}</h4>
                                </div>
                ...
                <div class="col">
                    <div class="card radius-10 border-start border-0 border-4 border-success">
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                <div>
                                    <p class="mb-0 text-secondary">Total Completed CMRS</p>
                                    <h4 class="my-1 text-success">{{$completeCmr->count()}}</h4>
                                </div>
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                <div>
                                    ...
                                    <h4 class="my-1 text-warning">{{$allUsers->count()}}</h4>
                                </div>
                    ...
                    <div class="card radius-10 w-100">
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-center ms-auto font-13 gap-2 mb-3">
                                <span class="border px-1 rounded cursor-pointer"><i class="bx bxs-circle me-1" style="color: #14abef"></i>CMR</span>
