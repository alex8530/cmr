...
<div class="row">
    <div class="col-3">
        ...
        <div class="form-check">
            <input class="form-check-input  parentGroup{{ str_replace('.', '_',trim($group->name))  }} flexCheckDefault" type="checkbox" value="{{ str_replace('.', '_',trim($group->name))  }}  ">
    ...
    <div class="col-9">
        ...
        <div class="form-check">
            <input class="form-check-input permission child_{{ str_replace('.', '_',trim($group->name))  }}" data-parent="{{ str_replace('.', '_',trim($group->name))  }}" type="checkbox" name="permission[]" value="{{ $permission->id }}" id="checkDefault{{ $permission->id }}">
