                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            ...
                            <form method="POST" action="{{ route('cmr.request.update',$CmrRequest->id) }}"
                                ...
                                <div class="card-body">
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9 text-secondary">
                                            <input readonly type="text" name="title" class="form-control "
                                                   value="{{@$CmrRequest->cmr->owner->name}}"
                                            />
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9 text-secondary">
                                            <input type="text" readonly name="description"
                                                   value="{{$CmrRequest->cmr->description}}" class="form-control"/>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9 text-secondary">
                                            <input type="text" readonly name="status"
                                                   value="{{$CmrRequest->cmr->status}}" class="form-control"/>

                                        </div>
                                    </div>
                                    @php
                                        $file_track =null;
                                       if($CmrRequest->level ==1) {
                                        $file_track = App\Models\FileTrack::where('cmr_id', $CmrRequest->cmr->id)
                                    ...
                                    @endphp
                                    @if ( $file_track!= null && $file_track->filename!= null)
                                        <div class="row mb-3">
                                            <div class="col-sm-3">
                                                <h6 class="mb-0">Origin File</h6>
                                            </div>
                                            <div class="col-sm-9 text-secondary">
                                                <a href="{{ route('cmr.download',  $file_track->filename) }}"
                                                   class="btn btn-primary px-5"
                                                   id="details">{{ $file_track->filename}}
                                                </a>
                                            </div>
                                        </div>
                                    @endif
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9 text-secondary">
                                            <input readonly type="date" name="request_date" class="form-control  "
                                                   value="{{$CmrRequest->cmr->request_date}}"
            ...
            @if( $CmrRequest->status ==='rejected'||  $CmrRequest->status ==='pending')
                <div class="col-md-12">
                    <div class="d-md-flex d-grid align-items-center gap-3">
                        ...
                        @else
                            <p class="text-danger">There is another level before you {{$CmrRequest->current_level}}
                                ,please wait your turn</p>
                        @endif
                    </div>
                </div>
